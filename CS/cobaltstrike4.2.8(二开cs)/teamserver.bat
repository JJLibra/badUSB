...
:run_cobal
    java -XX:ParallelGCThreads=4 -Dcobaltstrike.server_port=27000 -Djavax.net.ssl.keyStore=./cobaltstrike.store -Djavax.net.ssl.keyStorePassword=123456 -server -XX:+AggressiveHeap -XX:+UseParallelGC -Xms512M -Xmx1024M -classpath ./cobaltstrike.jar server.TeamServer %* cobaltstrike.store.profile